...
const productController = {
	...
	controlPanel: async (req, res) => {
		...
		// Osea como poder se puede, pero no deberia, porque alguien puede ingresar la URL manualmente y estaria bueno que lo rechaze,
		// Aunque tal vez seria mejor que se lo redirija a otra pagina y ahi salte el mensaje de alguna manera.
		else {
	...
	create: async (req, res) => {
		...
		const { name, shortDescription, year, measures, vesselType, description } =
			req.body;
